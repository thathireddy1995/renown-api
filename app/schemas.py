...
class SystemSettings(Base):
    ...
    legal_name: Mapped[str] = mapped_column(String(200), nullable=False, default="KOMMA CHANDRA SEKHAR")
    ...
    address_line2: Mapped[str] = mapped_column(String(160), nullable=False, default="Nearby Overhead Tank, Vedantha Puram")
