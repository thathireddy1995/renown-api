...
def product_out(
    ...
    *,
    ...
    return ProductOut(
        ...
        images=images,
        view_360_url=product.view_360_url or None,
        view360Url=product.view_360_url or None,
        view_360_key=product.view_360_key or None,
        view360Key=product.view_360_key or None,
        variants=variants,
        stock=stock,
        inStock=stock > 0,
        color=color,
